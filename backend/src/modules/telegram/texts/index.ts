...
export const iamgeText = ['Опишите изображение текстом или голосовым сообщением. Пример описания:',
    'Медведь как космический командир.',].join['\n'];


export const errorText = 'Что-то пошло не так';

export const roleText = ['Опишите текстом или голосовым сообщением как должен вести себя бот. Пример описания:',
    'Отвечай как будто ты великий математик.',].join('\n');


export const answerGenerationText = ['<code>Подождите, идет генерация ответа...</code>'].join('\n');

export const dialogText = [
    'Тут вы можете выбирать и удалять диалоги.'
].join('\n');