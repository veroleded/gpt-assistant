export const startText = [
    ...
    '',
    '📝 ТЕКСТ: просто напишите вопрос в чат',
    ...
    '',
    '🎸 МУЗЫКА: введите /music, выберите жанр и добавьте текст песни (доступно в /Suno).',
].join('\n');
...
export const helpText = [
    ...
    '/music– генерация песни, бот вам предложит ввести жанр и текст',
    '',
    '⚙️ Другие команды',
    '/start – описание бота',
